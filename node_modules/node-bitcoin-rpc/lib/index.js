...
module.exports.BITCOIND_HOSTNAME = 'localhost'  //3.0.18.44
module.exports.BITCOIND_PORT = 18332
module.exports.BITCOIND_USERNAME = 'MyRpcUsername'  //configuration username inside node folder
module.exports.BITCOIND_PASSWORD = 'MyRpcPassword'  //configuration password inside node folder
...
module.exports.call = function call (username, method, params, cb) {  //add username params
  ...
  var options = {
    ...
    path: '/wallet/'+username,  //cli path(not folder wallet path)  '/wallet/'+username
    method: 'POST',
    headers: {
